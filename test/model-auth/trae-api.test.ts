...
import { completeTrae, listTraeModels, streamTrae } from "../../model-auth/packages/providers/src/trae-api";
import type { TraeCredential } from "../../model-auth/packages/providers/src/trae";
