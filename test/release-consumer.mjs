...
for (const name of ['authorizeOpenAI', 'refreshOpenAI', 'authorizeAnthropic', 'refreshAnthropic', 'authorizeWorkBuddy', 'authorizeTrae']) assert.equal(typeof providers[name], 'function', name);
