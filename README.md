...
{
  "dependencies": {
    "@lsypkg/fluent": "https://github.com/lsy-404/platform-kit/releases/download/v0.5.2/platform-kit-fluent-0.2.1.tgz",
    "@model-auth/core": "https://github.com/lsy-404/platform-kit/releases/download/v0.5.2/model-auth-core-0.5.2.tgz",
    "@model-auth/providers": "https://github.com/lsy-404/platform-kit/releases/download/v0.5.2/model-auth-providers-0.5.2.tgz",
    "@model-auth/vue": "https://github.com/lsy-404/platform-kit/releases/download/v0.5.2/model-auth-vue-0.5.2.tgz"
  }
}
```
...
```toml
model-auth-native = { git = "https://github.com/lsy-404/platform-kit", tag = "v0.5.2" }
```

The release also includes `model-auth-native-0.5.2.crate`. See [native authentication](model-auth/rust/README.md) for the backend API.
