...
{
  "dependencies": {
    "@lsypkg/fluent": "https://github.com/lsy-404/platform-kit/releases/download/v0.3.0/platform-kit-fluent-0.2.1.tgz",
    "@model-auth/core": "https://github.com/lsy-404/platform-kit/releases/download/v0.3.0/model-auth-core-0.3.0.tgz",
    "@model-auth/providers": "https://github.com/lsy-404/platform-kit/releases/download/v0.3.0/model-auth-providers-0.3.0.tgz",
    "@model-auth/vue": "https://github.com/lsy-404/platform-kit/releases/download/v0.3.0/model-auth-vue-0.4.0.tgz"
  }
}
```
