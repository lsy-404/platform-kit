...
{
  "dependencies": {
    "@lsypkg/fluent": "https://github.com/lsy-404/platform-kit/releases/download/v0.1.1/platform-kit-fluent-0.1.1.tgz",
    "@model-auth/core": "https://github.com/lsy-404/platform-kit/releases/download/v0.1.1/model-auth-core-0.2.7.tgz",
    "@model-auth/providers": "https://github.com/lsy-404/platform-kit/releases/download/v0.1.1/model-auth-providers-0.2.7.tgz",
    "@model-auth/vue": "https://github.com/lsy-404/platform-kit/releases/download/v0.1.1/model-auth-vue-0.2.7.tgz"
  }
}
```
