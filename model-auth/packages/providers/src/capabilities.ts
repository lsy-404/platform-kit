...
export const MODEL_AUTH_PROVIDER_CAPABILITIES: readonly ModelAuthProviderCapability[] = Object.freeze([
  ...
  { id: "workbuddy", displayName: "WorkBuddy", authorization: { kind: "browser-oauth", renewable: true, multiAccount: true }, access: { inference: true, modelCatalog: true, usage: true }, catalogProviderIds: ["zhipuai", "tencent-tokenhub", "deepseek"], catalogProviderId: "zhipuai" },
